...
import com.orbitalsonic.admobadsconfigurations.adsconfig.constants.AdsConstants.adMobPreloadNativeAd
import com.orbitalsonic.admobadsconfigurations.adsconfig.constants.AdsConstants.isNativeLoading
        ...
        activity?.let {mActivity ->
            try {
                adMobPreloadNativeAd?.let { ad ->
                    ...
                    val adView: NativeAdView = if (nativeType == NativeType.SMALL) {
